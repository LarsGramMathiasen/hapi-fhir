package ca.uhn.fhir.profiling.fhir;
...
import ca.uhn.fhir.profiling.fhir.common._EventMarkerComponent;
import ca.uhn.fhir.profiling.fhir.common._PayorComponent;
import ca.uhn.fhir.profiling.fhir.common._PreviousComponent;
...
import static ca.uhn.fhir.profiling.fhir.MyEpisodeOfCareFHIR.*;

@ResourceDef(name = FHIR_RESOURCE_NAME, id = FHIR_PROFILE_NAME, profile = FHIR_PROFILE_URI)
